...
#   timestamp: 2025-07-18T10:01:31+00:00
...
class Insight(BaseModel):
    ...
    generatedTime: Annotated[
        Optional[int],
        Field(description='Gets the Unix time this insight was generated.'),
    ] = None
    createdTime: Annotated[
        Optional[int], Field(description='Gets the Unix time this insight was created.')
    ] = None
    closeTime: Annotated[
        Optional[int], Field(description='Gets the Unix time this insight was closed.')
    ] = None
    symbol: Annotated[
    ...
    scoreDirection: Annotated[
        Optional[str], Field(description='Gets the direction score.')
    ] = None
    scoreMagnitude: Annotated[
        Optional[str], Field(description='Gets the magnitude score.')
    ] = None
...
class LiveAlgorithm(BaseModel):
    ...
    status: Annotated[
        Optional[Status2], Field(description='States of a live deployment.')
    ] = None
    launched: Annotated[
        Optional[datetime],
...
class OrderEvent(BaseModel):
    ...
    status: Annotated[Optional[Status4], Field(description='Status of the Order.')] = (
        None
    )
...
class ListLiveAlgorithmsRequest(BaseModel):
    status: Annotated[
        Optional[Status5], Field(description='States of a live deployment.')
    ] = None
    start: Annotated[
        Optional[float],
        Field(
